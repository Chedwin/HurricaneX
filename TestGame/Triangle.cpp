...
bool Triangle::InitTriangle(DXRenderer* renderer)
{
	...
	HRESULT hr = D3DCompileFromFile(L"StandardShader.fx", nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE, "VSMain", "vs_5_0", D3DCOMPILE_DEBUG, 0, &VS_Buffer, &Errors);
	hr = D3DCompileFromFile(L"StandardShader.fx", nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE, "PSMain", "ps_5_0", D3DCOMPILE_DEBUG, 0, &PS_Buffer, &Errors);
